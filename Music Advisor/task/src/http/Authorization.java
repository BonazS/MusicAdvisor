...
public class Authorization {
    ...
    private final HttpClient authorization;
    ...
    public Authorization() {
        authorization = HttpClient.newBuilder().build();
    }

    public Authorization(String spotifyAccessPoint) {
        this();
    ...
    public HttpResponse<String> sendSpotifyAccessToken() throws IOException, InterruptedException {
        HttpRequest spotifyAccessTokenRequest = HttpRequest.newBuilder()
                ...
                .build();
        return sendHttpRequest(spotifyAccessTokenRequest);
    }

    public HttpResponse<String> sendHttpRequest(HttpRequest request) throws IOException, InterruptedException {
        return authorization.send(request, HttpResponse.BodyHandlers.ofString());
    }
}